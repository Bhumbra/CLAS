...
class tinner {
	public:
		...
		virtual void init(T* _OP = (T*)0, T* _I0 = (T*)0, T* _I1 = (T*)0,
											U _M = (U)0, U _K = (U)0, U _P = (U)1, U _Q = (U)1,
											bool _I0C = false, T* _I2 = (T*)0, U 
											_D = (U)0, U _R = (U)0, U _A = (U)0);
...
tinner<T, U>::tinner( T* _OP, T* _I0, T* _I1, U _M, U _K, U _P, U _Q,
	...
	this -> init(	_OP, _I0, _I1, _M, _K, _P, _Q, _I0C, _I2, _D, _R, _A);
}
...
//---------------------------------------------------------------------------
template <class T, class U>
void tinner<T, U>::setCmj(bool _I0C) {
	this -> i0c = _I0C;
	this -> setStr();
	this -> chkStr();
}
...
static inline void tinner_product(T* _OP, 
																	...
																	T* _I2 = (T*)0) {
	tinner<T, U> Tinner;
	Tinner.init(_OP, _I0, _I1, _m, _k, _p, _q, _i0c, _I2);
  Tinner.exec();
}
