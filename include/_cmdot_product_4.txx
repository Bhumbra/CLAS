...
static inline void cmdot_product_4x2 (T* Out, 
  ...
  Out0 = Out + OIs * 0;
	...
	if (mod) {
		div = n - mod;
		cmdot_product_4x1(Out + div, In0, _In1 + div, k, mod, OIs, In0s);
	}
}
...
static inline void cmdot_product_4x4 (T* Out, 
	...
	if (mod) {
		div = n - mod;
		cmdot_product_4x2(Out + div, In0, _In1 + div, k, mod, OIs, In0s);
	}
}
...
static inline void cmdot_product_4x8 (T* Out, 
	...
	if (mod) {
		div = n - mod;
		cmdot_product_4x4(Out + div, In0, _In1 + div, k, mod, OIs, In0s);
	}
}
...
static inline void cmdot_product_4x16(T* Out, 
	...
	if (mod) {
		div = n - mod;
		cmdot_product_4x8(Out + div, In0, _In1 + div, k, mod, OIs, In0s);
	}
}
...
static inline void cmdot_product_4x32(T* Out, 
	...
	if (mod) {
		div = n - mod;
		cmdot_product_4x16(Out + div, In0, _In1 + div, k, mod, OIs, In0s);
	}
}
...
static inline void cmdot_product_4x64(T* Out, 
	...
	if (mod) {
		div = n - mod;
		cmdot_product_4x32(Out + div, In0, _In1 + div, k, mod, OIs, In0s);
	}
}
