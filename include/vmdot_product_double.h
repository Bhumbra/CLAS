...
extern "C" void vmdot_product_double_1x1x1(double* Out, double* In0, double* _In1, uint64_t m, uint64_t k, uint64_t n, uint64_t OutS, uint64_t In0S, uint64_t In0s, uint64_t In1s);
extern "C" void vmdot_product_double_2x2x2(double* Out, double* In0, double* _In1, uint64_t m, uint64_t k, uint64_t n, uint64_t OutS, uint64_t In0S, uint64_t In0s, uint64_t In1s);
extern "C" void vmdot_product_double_4x4x4(double* Out, double* In0, double* _In1, uint64_t m, uint64_t k, uint64_t n, uint64_t OutS, uint64_t In0S, uint64_t In0s, uint64_t In1s);
# else
...
void vmdot_product_double_1x1x1(double* Out, double* In0, double* _In1, uint64_t m, uint64_t k, uint64_t n, uint64_t OutS, uint64_t In0S, uint64_t In0s, uint64_t In1s);
void vmdot_product_double_2x2x2(double* Out, double* In0, double* _In1, uint64_t m, uint64_t k, uint64_t n, uint64_t OutS, uint64_t In0S, uint64_t In0s, uint64_t In1s);
void vmdot_product_double_4x4x4(double* Out, double* In0, double* _In1, uint64_t m, uint64_t k, uint64_t n, uint64_t OutS, uint64_t In0S, uint64_t In0s, uint64_t In1s);
# endif
