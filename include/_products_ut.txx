...
static inline void rmdot_product_ut(T* Out, 
	...
	switch (U0) {
		case 1: {
			return rmdot_product_1(Out, In0, In1, m, k, n, In2, U1);
		}
		case 2: {
			return rmdot_product_2(Out, In0, In1, m, k, n, In2, U1);
		}
		default: {
			return rmdot_product_4(Out, In0, In1, m, k, n, In2, U1);
		}
	}
}
//------------------------------------------------------------------------------
...
static inline void cmdot_product_ut(T* Out, 
	...
	switch (U0) {
		case 1: {
			return cmdot_product_1(Out, In0, In1, m, k, n, In2, U1);
		}
		case 2: {
			return cmdot_product_2(Out, In0, In1, m, k, n, In2, U1);
		}
		default: {
			return cmdot_product_4(Out, In0, In1, m, k, n, In2, U1);
		}
	}
}
//------------------------------------------------------------------------------
...
static inline void mrdot_product_ut(T* Out, 
	...
	switch (U0) {
		case 1: {
			return mrdot_product_1(Out, In0, In1, m, k, n, OutCm, In2, U1);
		}
		case 2: {
			return mrdot_product_2(Out, In0, In1, m, k, n, OutCm, In2, U1);
		}
		default: {
			return mrdot_product_4(Out, In0, In1, m, k, n, OutCm, In2, U1);
		}
	}
}
...
static inline void mcdot_product_ut(T* Out, 
	...
	switch (U0) {
		case 1: {
			return mcdot_product_1(Out, In0, In1, m, k, n, OutCm, In2, U1);
		}
		case 2: {
			return mcdot_product_2(Out, In0, In1, m, k, n, OutCm, In2, U1);
		}
		default: {
			return mcdot_product_4(Out, In0, In1, m, k, n, OutCm, In2, U1);
		}
	}
}
  ...
  // Scalar/vector outputs fast-track
	...
	if (k == 1) {     
		if (!In2) {       // No maxuend
			...
			if (!OutCm) {    // untransposed product
				return mrdot_product_ut(Out, In0, In1, (U)m, (U)1, (U)1, OutCm, In2, U0, U1);
			}
